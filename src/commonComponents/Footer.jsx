...
const Footer = () => {
    ...
    return (
        <div className="bg-[#2f2f2f]">
            <div className="w-full max-w-screen-xl mx-auto flex pt-24 pb-6">
                <div className='grid grid-cols-5 gap-6'>
                    ...
                    <div className="text-white text-[30px] font-bold flex flex-1 justify-evenly gap-8">
                        <div className="mb-6">
                            <p className="pb-6">SHOP&nbsp;ONLINE</p>
                            <hr className="!w-[50%]" />
                            <ul className="flex flex-col gap-7 mt-11">
                                <li className="text-[18px] font-medium">AMAZON</li>
                            </ul>
                        ...
                        <div className="mb-6">
                            <p className="pb-6">IMPORTANT&nbsp;LINKS</p>
                            <hr className="!w-[50%]" />
                            <ul className="flex flex-col gap-7 mt-11">
                                <li className="text-[18px] font-medium">Company Profile</li>
                        ...
                        <div className='mb-6'>
                            <p className="pb-6">STAY&nbsp;CONNECTED</p>
                            <hr className="!w-[50%]" />
                            <div className="flex gap-7 mt-11 cursor-pointer">
                                <img src="/images/footerIcons/Instagram.svg" width={62} height={62} alt="Instagram Logo" />
                                <img src="/images/footerIcons/Facebook.svg" width={62} height={62} alt="Facebook Logo" />
                                <img src="/images/footerIcons/LinkedIn.svg" width={62} height={62} alt="LinkedIn Logo" />
                                <img src="/images/footerIcons/TwitterX.svg" width={62} height={62} alt="Twitter Logo" />
                                <img src="/images/footerIcons/YouTube.svg" width={62} height={62} alt="YouTube Logo" />
                            </div>
                            <ul className="max-w-[445px] flex flex-col gap-7 mt-7">
                                <li className="flex items-center gap-4">
            ...
            <div className="flex pb-8 border-t xl:justify-between xl:items-start justify-center items-center w-[80%] h-[62px] mx-auto">
