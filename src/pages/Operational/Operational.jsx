...
import { fontmd, fontxs, mblg, pMd, ptlg, pXSm } from '../../utils/constant';
    ...
    const videos = [
        {
            ...
            description: "Learn the basics of React with this comprehensive tutorial covering components, state, and props."
        },
        {
            id: 2,
            src: "https://www.youtube.com/embed/VIDEO_ID_2",
            title: "Advanced React Patterns",
            description: "Delve into advanced React patterns like context, hooks, and performance optimization."
        },
        {
            id: 3,
            src: "https://www.youtube.com/embed/VIDEO_ID_3",
            title: "JavaScript Tips & Tricks",
            description: "Boost your JavaScript skills with these essential tips and tricks for writing cleaner code."
        },
        {
            id: 4,
        ...
        <section>
            ...
            <div className={`w-[90%] sm:max-w-[1200px] mx-auto ${mblg}`}>
                ...
                <div className="flex gap-5">
                            ...
                            return (
                                <div
                                    ...
                                    className={`cursor-pointer ${i.label !== "APP" && "border-b-2"
                                        }  border-black ${pXSm} ${fontxs} font-bold ${activeTab === i?.label ? "text-blue-600" : ""
                                        }`}
                                    onClick={() => {
                    ...
                    {/* Left Section  */}
                    <div className="w-full sm:w-[70%] mx-auto bg-white rounded-2xl p-5">
